...
class main:
	...
	def passwords():
		...
		my_background.create_text(220,120,font=('Sitka Small',14,'bold' ), text="  User ID: ",fill="white")
		my_background.create_text(230,185,font=('Sitka Small',14,'bold' ), text="Password: ",fil="white")
		...
		button_login_window = my_background.create_window(197, 250, anchor="nw", window=button_login)
